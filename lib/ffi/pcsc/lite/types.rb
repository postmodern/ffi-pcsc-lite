...
module FFI
  module PCSC
    module Lite
      ...
      typedef :pointer, :PSCARDCONTEXT
      typedef :pointer, :LPSCARDCONTEXT

      typedef :long,    :SCARDHANDLE
      typedef :pointer, :PSCARDHANDLE
      typedef :pointer, :LPSCARDHANDLE

      typedef :pointer, :LPSCARD_READERSTATE

      typedef :pointer, :LPSCARD_IO_REQUEST
      typedef :pointer, :LPCSCARD_IO_REQUEST

      # Maximum ATR size
      SCARD_ATR_LENGTH = MAX_ATR_SIZE = 33

      #
      # error codes from http://msdn.microsoft.com/en-us/library/aa924526.aspx
      #
      SCARD_S_SUCCESS                 = 0x00000000  #  No error was encountered.
      ...
      SCARD_AUTOALLOCATE   = -1		#  see SCardFreeMemory()
      ...
      SCARD_PROTOCOL_UNDEFINED = 0x0000	#  protocol not set
      SCARD_PROTOCOL_UNSET     = SCARD_PROTOCOL_UNDEFINED	# backward compat
      ...
      SCARD_STATE_ATRMATCH    = 0x0040	#  ATR matches card
